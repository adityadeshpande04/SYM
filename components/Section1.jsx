...
export default function Section1(){
    ...
    return(
            <div className=" relative md:text-8xl font-extrabold flex flex-col gap-8 justify-center text-3xl">
                <div className=" relative flex flex-col top-20 left-10 md:gap-6 gap-2">
                <h1>Catchy Line</h1>
                <h1>Catchy Line</h1>
                ...
                <div className="relative flex flex-col pt-16">
                    <div className="relative flex md:flex-row flex-col md:gap-8 gap-1 left-10 justify-start">
                    ...
                    <div className="relative flex md:flex-row flex-col md:gap-8 gap-1 left-10 justify-start md:text-base text-sm" >
                ...
                <div className="relative flex md:flex-row flex-col gap-8 left-10">
